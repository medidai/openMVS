...
// find the similarity transform that best aligns the given two sets of
// corresponding 3D points
bool SEACAVE::SimilarityTransform(const CLISTDEF0(Point3) & points,
                                  const CLISTDEF0(Point3) & pointsRef,
                                  Matrix4x4 &transform) {
...
void SEACAVE::DecomposeSimilarityTransform(const Matrix4x4 &transform,
                                           Matrix3x3 &R, Point3 &t, REAL &s) {
  const Eigen::Transform<REAL, 3, Eigen::Affine, Eigen::RowMajor> T(
      static_cast<const Matrix4x4::EMat &>(transform));
