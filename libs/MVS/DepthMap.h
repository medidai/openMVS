...
extern float fNormalPriorWeight;
} // namespace OPTDENSE
/*----------------------------------------------------------------*/
...
struct MVS_API DepthData {
	...
	NormalMap priorNormalMap; // persistent normal prior (e.g. MoGe) in camera space, camera-facing; zero-vector = invalid (optional)
