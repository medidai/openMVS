...
protected:
  ...
  const char *const *write_type_names; // names of scalar types to be used for
                                       // writing (new types by default)

  static const char *const type_names[9]; // names of scalar types
  static const char
      *const old_type_names[9]; // old names of types for backward compatibility
