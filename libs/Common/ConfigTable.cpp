 ...
 */
void CConfigTable::Release() { m_oSML.Release(); }
/*----------------------------------------------------------------*/
 ...
 */
void CConfigTable::Remove(const String &name) { m_oSML.DestroyChild(name); }
/*----------------------------------------------------------------*/
 ...
 */
bool CConfigTable::Load(const String &f) { return m_oSML.Load(f); } // Load
 ...
 */
void STCALL CConfigTable::ItemInitData(const String &key, SMLVALUE &val,
                                       void *) {
...
/**
 * Save a config item for the given SML entry. Return false if this item should
 * not be saved.
 */
