...
BUILTIN_DESCRIPTORS = {
    ...
    for item in (
        ...
        _descriptor("apd_winner_runner_up_gap", "candidate_update", "winner_runner_up_gap", label="APD evaluated-candidate gap", units="cost", domain="nonnegative", preferred_direction="higher", minimum_profile="deep", colormap="viridis", default_visible=True, component_id="apd_working_objective", description="Exact runner-up minus best cost in the unconstrained evaluated-candidate ordering. This is not a selected-winner gap where an optional constraint rejects the raw best."),
        ...
        _descriptor("dvp_incumbent_depth", "geometry", "incumbent_depth", label="DVP incoming depth", units="m", domain="positive", minimum_profile="deep", colormap="turbo", component_id="dvp_geometry"),
        _descriptor("dvp_final_depth", "geometry", "final_depth", label="DVP final depth", units="m", domain="positive", minimum_profile="deep", colormap="turbo", component_id="dvp_geometry"),
        _descriptor("dvp_depth_displacement", "geometry", "depth_displacement", label="DVP final depth displacement", units="m", domain="nonnegative", preferred_direction="contextual", minimum_profile="deep", colormap="viridis", default_visible=True, component_id="dvp_geometry"),
        _descriptor("dvp_left_interval_minimum", "geometry", "left_interval_minimum", label="DVP left interval minimum", units="m", domain="positive_or_unavailable", minimum_profile="deep", colormap="turbo", component_id="dvp_interval"),
        _descriptor("dvp_left_interval_maximum", "geometry", "left_interval_maximum", label="DVP left interval maximum", units="m", domain="positive_or_unavailable", minimum_profile="deep", colormap="turbo", component_id="dvp_interval"),
        _descriptor("dvp_right_interval_minimum", "geometry", "right_interval_minimum", label="DVP right interval minimum", units="m", domain="positive_or_unavailable", minimum_profile="deep", colormap="turbo", component_id="dvp_interval"),
        _descriptor("dvp_right_interval_maximum", "geometry", "right_interval_maximum", label="DVP right interval maximum", units="m", domain="positive_or_unavailable", minimum_profile="deep", colormap="turbo", component_id="dvp_interval"),
        _descriptor("dvp_left_interval_valid", "geometry", "left_interval_valid", label="DVP left interval valid", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_interval"),
        _descriptor("dvp_right_interval_valid", "geometry", "right_interval_valid", label="DVP right interval valid", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_interval"),
        *(
            _descriptor(signal, "geometry", quantity, label=label, units="samples", domain="nonnegative", minimum_profile="deep", colormap="cividis", component_id="dvp_interval")
            for signal, quantity, label in (
                ("dvp_left_outer_count", "left_outer_support", "DVP left outer support"),
                ("dvp_left_inner_count", "left_inner_support", "DVP left inner support"),
                ("dvp_right_inner_count", "right_inner_support", "DVP right inner support"),
                ("dvp_right_outer_count", "right_outer_support", "DVP right outer support"),
            )
        ),
        _descriptor("dvp_incumbent_cost", "cost", "incumbent_cost", label="DVP incumbent cost", units="cost", domain="nonnegative", preferred_direction="lower", minimum_profile="deep", colormap="magma", default_visible=True, component_id="dvp_candidate_objective"),
        _descriptor("dvp_winner_cost", "cost", "winner_cost", label="DVP winner cost", units="cost", domain="nonnegative", preferred_direction="lower", minimum_profile="deep", colormap="magma", default_visible=True, component_id="dvp_candidate_objective"),
        _descriptor("dvp_runner_up_cost", "cost", "runner_up_cost", label="DVP runner-up cost", units="cost", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", component_id="dvp_candidate_objective"),
        _descriptor("dvp_winner_runner_up_gap", "candidate_update", "winner_runner_up_gap", label="DVP winner gap", units="cost", domain="nonnegative_or_unavailable", preferred_direction="higher", minimum_profile="deep", colormap="viridis", default_visible=True, component_id="dvp_candidate_objective"),
        _descriptor("dvp_family", "candidate_update", "family", label="DVP proposal family", domain="enum", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_candidate_update"),
        _descriptor("dvp_unavailable_reason", "candidate_update", "unavailable_reason", label="DVP proposal availability", domain="enum", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        *(
            _descriptor(signal, "candidate_update", quantity, label=label, units="proposals", domain="nonnegative", minimum_profile="deep", colormap="cividis", component_id="dvp_candidate_update")
            for signal, quantity, label in (
                ("dvp_generated_count", "generated_count", "DVP proposals generated"),
                ("dvp_tested_count", "tested_count", "DVP proposals tested"),
                ("dvp_finite_count", "finite_count", "DVP finite proposals"),
                ("dvp_accepted_count", "accepted_count", "DVP sequential acceptances"),
            )
        ),
        *(
            _descriptor(signal, "candidate_update", quantity, label=label, domain="bit_mask", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_candidate_update")
            for signal, quantity, label in (
                ("dvp_tested_proposal_mask", "tested_mask", "DVP tested proposal mask"),
                ("dvp_finite_proposal_mask", "finite_mask", "DVP finite proposal mask"),
                ("dvp_accepted_proposal_mask", "accepted_mask", "DVP accepted proposal mask"),
            )
        ),
        _descriptor("dvp_winner_ordinal", "candidate_update", "winner_ordinal", label="DVP winning proposal", domain="enum", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_candidate_update"),
        _descriptor("dvp_accepted", "candidate_update", "accepted", label="DVP proposal accepted", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        _descriptor("dvp_final_winner", "candidate_update", "final_hypothesis_winner", label="DVP final full-hypothesis winner", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        _descriptor("dvp_final_update_source", "candidate_update", "final_update_source", label="DVP final update source", domain="enum", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        _descriptor("dvp_final_depth_retained", "candidate_update", "final_depth_retained", label="DVP depth retained after later refinements", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        _descriptor("dvp_native_depth_fallback", "candidate_update", "native_depth_fallback", label="DVP native-depth fallback", domain="boolean", minimum_profile="deep", measurement_kind="enum", colormap="tab20", default_visible=True, component_id="dvp_candidate_update"),
        _descriptor("dvp_selected_source_views", "view_selection", "selected_source_view_mask", label="DVP selected source-view mask", domain="bit_mask", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_view_evidence"),
        _descriptor("dvp_direction_source_views", "view_selection", "direction_source_view_mask", label="DVP valid epipolar-direction view mask", domain="bit_mask", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_view_evidence"),
        *tuple(
            descriptor
            for proposal in range(2)
            for descriptor in (
                _descriptor(f"dvp_proposal_depth_{proposal}", "geometry", f"proposal_{proposal}_depth", label=f"DVP proposal {proposal} depth", units="m", domain="positive_or_unavailable", minimum_profile="deep", colormap="turbo", default_visible=True, component_id="dvp_proposal"),
                _descriptor(f"dvp_candidate_cost_{proposal}", "cost", f"proposal_{proposal}_cost", label=f"DVP proposal {proposal} cost", units="cost", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", default_visible=True, component_id="dvp_candidate_objective"),
                _descriptor(f"dvp_mean_reprojection_error_{proposal}", "geometry", f"proposal_{proposal}_mean_reprojection_error", label=f"DVP proposal {proposal} mean reprojection error", units="px", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", component_id="dvp_global_gate"),
                _descriptor(f"dvp_max_reprojection_error_{proposal}", "geometry", f"proposal_{proposal}_max_reprojection_error", label=f"DVP proposal {proposal} max reprojection error", units="px", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", component_id="dvp_global_gate"),
                _descriptor(f"dvp_mean_relative_depth_error_{proposal}", "geometry", f"proposal_{proposal}_mean_relative_depth_error", label=f"DVP proposal {proposal} mean relative-depth error", units="ratio", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", component_id="dvp_global_gate"),
                _descriptor(f"dvp_max_relative_depth_error_{proposal}", "geometry", f"proposal_{proposal}_max_relative_depth_error", label=f"DVP proposal {proposal} max relative-depth error", units="ratio", domain="nonnegative_or_unavailable", preferred_direction="lower", minimum_profile="deep", colormap="magma", component_id="dvp_global_gate"),
                _descriptor(f"dvp_signed_offset_{proposal}", "geometry", f"proposal_{proposal}_signed_offset", label=f"DVP proposal {proposal} signed side/offset", units="px or side", domain="signed", minimum_profile="deep", colormap="coolwarm", signed=True, component_id="dvp_proposal"),
                _descriptor(f"dvp_source_view_{proposal}", "view_selection", f"proposal_{proposal}_source_view", label=f"DVP proposal {proposal} source view", domain="enum", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_view_evidence"),
                _descriptor(f"dvp_support_{proposal}", "view_selection", f"proposal_{proposal}_support", label=f"DVP proposal {proposal} support", units="views", domain="nonnegative", minimum_profile="deep", colormap="cividis", component_id="dvp_view_evidence"),
                _descriptor(f"dvp_support_views_{proposal}", "view_selection", f"proposal_{proposal}_support_view_mask", label=f"DVP proposal {proposal} support-view mask", domain="bit_mask", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_view_evidence"),
                _descriptor(f"dvp_occluded_views_{proposal}", "view_selection", f"proposal_{proposal}_occluded_view_mask", label=f"DVP proposal {proposal} occluded-view mask", domain="bit_mask", minimum_profile="deep", measurement_kind="enum", colormap="tab20", component_id="dvp_global_gate"),
            )
        ),
    )
}
