...
bool Application::Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("save-dmaps-float16", boost::program_options::value(&OPT::bSaveDmapsFloat16)->default_value(false), "save depth-maps in 16-bit float format instead of 32-bit float for reduced file size")
	...
	OPTDENSE::nFuseFilter = nFuseFilter;
		...
		OPTDENSE::bSaveDmapsFloat16 = OPT::bSaveDmapsFloat16;
